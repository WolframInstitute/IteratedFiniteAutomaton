<|"IndexedPaths" -> None, "Driver" -> "Lucene", 
 "CreationDate" -> DateObject[{2026, 7, 27, 1, 55, 
    9.076707`7.710503303164463}, "Instant", "Gregorian", 2.], "Version" -> 5, 
 ...
 "ContentFieldOptions" -> <|"Abstract" -> <|"Weight" -> 1.5|>, 
   ...
   "URI" -> <|"Stored" -> True, "Tokenized" -> False, 
     "LengthWeighted" -> False|>, "URL" -> <|"Stored" -> True, 
     "Searchable" -> False, "Tokenized" -> False|>, 
   "Usage" -> <|"Weight" -> 1.5|>|>, "ContentLocationFunction" -> 
  <|"SnippetSource" -> Function[{content}, "field:SnippetPlaintext"]|>, 
