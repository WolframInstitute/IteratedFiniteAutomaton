...
- <a id="EpsteinShub1968"></a>**EpsteinShub1968** — David B. A. Epstein, Michael Shub, *Expanding endomorphisms of flat manifolds*, Topology **7** (1968), 139–141. [10.1016/0040-9383(68)90022-0](https://doi.org/10.1016/0040-9383(68)90022-0)
  Every closed flat manifold admits an expanding endomorphism. With the contraction criterion below this makes every Bieberbach group a contracting finite-state self-similar group, which is why the realization of $P$ is a corollary rather than a discovery; its dilation construction gives degree $k^3$ for odd $k$, so 27 for $P$ against the 3 achieved by a twisted contraction.
- <a id="Tsapogas1994"></a>**Tsapogas1994** — Georgios Tsapogas, *Expanding endomorphisms of crystallographic manifolds*, Topology Appl. **60** (1994). [10.1016/0166-8641(94)00014-X](https://doi.org/10.1016/0166-8641(94)00014-X)
  **Not read.** Recorded because its title is the closest match to the minimal-degree question, so it is the first place a collision with that claim would appear.
- <a id="DekimpeDere2014"></a>**DekimpeDere2014** — Karel Dekimpe, Jonas Deré, *Expanding maps and non-trivial self-covers on infra-nilmanifolds*. [arXiv:1407.8106](https://arxiv.org/abs/1407.8106)
  The complete algebraic characterization of which infra-nilmanifolds admit an expanding map, and of which almost-Bieberbach groups are co-Hopfian: the general form of the existence question, whose flat case is Epstein–Shub. Published version not verified here.
- <a id="BondarenkoZashkolny2024"></a>**BondarenkoZashkolny2024** — Ievgen Bondarenko, Dmytro Zashkolny, *Virtual endomorphisms of the group $pg$*, Researches in Mathematics **32** (2024), no. 1, 3–15.
  All virtual endomorphisms of the Klein bottle group, which are simple, and the complete degree set: a transitive finite-state self-similar action of degree $d$ exists iff $d \geq 2$ is not an odd prime. The template for how a degree question of this kind should be answered, and the mirror image of $P$, where 3 works and 2 does not. No DOI verified here.
